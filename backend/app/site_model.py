...
class UnitTag:
    ...
    def semantic(self) -> str:
        return (self.semantic_key or self.key).strip().casefold()
    ...
    def resolve_tag(self, unit_key: str, query: str) -> UnitTag | None:
        ...
        for tag in unit.tags:
            candidates = {
                ...
                tag.label.casefold(),
                tag.semantic,
                *(alias.casefold() for alias in tag.aliases),
            }
...
def _site_from_payload(payload: dict[str, object]) -> SiteModel:
    ...
    for raw_unit in raw_units:
        ...
        for raw_tag in raw_tags:
            ...
            semantic_key = str(raw_tag.get("semantic_key") or tag_key).strip().casefold()
